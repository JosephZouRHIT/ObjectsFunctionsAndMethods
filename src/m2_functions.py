...
def turtle4():
    Koopa = rg.SimpleTurtle('turtle')
    Koopa.pen = rg.Pen('red', 20)

    Koopa.forward(100)


def turtle5():
    Goomba = rg.SimpleTurtle('triangle')
    Goomba.pen = rg.Pen('blue', 20)

    Bowser = rg.SimpleTurtle('square')
    Bowser.pen = rg.Pen('yellow', 20)
