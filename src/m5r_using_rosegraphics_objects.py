...
#            window = rg.RoseWindow(900, 100, 'Test Window')
#
...
#               clone, detach_from, move_by
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle objects have:
#                center point, radius, fill color
#
#     f. What does a RoseWindow RENDER method do?
#            Print the objects linked to the window on screen
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            If you are trying to keep the window showing, then the method is necessary because without
#            close_on_mouse_click method the window will shut down immediately.
#
